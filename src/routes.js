...
const routes = [
  ...
  { path: '/Liste/ProjetsenCours', name: 'Projetencours', component: Cards },
  { path: '/base/forms', name: 'Forms', component: Forms },
  { path: '/base/switches', name: 'Switches', component: Switches },
  { path: '/base/tables', name: 'Tables', component: Tables },
  { path: '/base/tabs', name: 'Tabs', component: Tabs },
  { path: '/Liste/touslesprojets', name: 'projets', component: Breadcrumbs },
  { path: '/Liste/Projetslibres', name: 'Projetslibres', component: Carousels },
  ...
  { path: '/Etudiants/Tous', name: 'Etudiants', component: ButtonDropdowns },
  { path: '/Etudiants/approuvées', name: 'Etudiants approuvées', component: ButtonGroups },
  { path: '/Etudiants/EnAttentes', name: 'EtudiantsEnAttente', component: BrandButtons },
